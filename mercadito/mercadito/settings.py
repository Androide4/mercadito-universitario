...
SECRET_KEY = 'django-insecure-k-kyzd@5-%^x12r-o6ntn4q(20z*=u9f_a*cpqhuxxsx_ukxp+'
...
INSTALLED_APPS = [
    'mercadito.apps.MongoAdminConfig',
    'mercadito.apps.MongoAuthConfig',
    'mercadito.apps.MongoContentTypesConfig',
